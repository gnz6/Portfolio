...
const Contact = () => {
  return (
    <div name="contact" className='w-full h-screen bg-[#121f3d] flex justify-center items-center p-4 mt-[200px]'>
        <form className='flex flex-col max-w-[1000px] w-full'method="POST" action="https://getform.io/f/28657746-51a3-47a4-b83c-56906c2282c0">
            ...
            <button className='text-white border-2 hover:bg-[#d57d26] hover: border-[#d57d26] px-4 py-3 my-8 mx-auto items-center  transition duration-100'>Contact me!</button>
        </form>
    </div>
  )
}
